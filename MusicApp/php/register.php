...
<body>
    <div class="register form_user">
        ...
        <form method="post" autocomplete="off" id="myform">
            ...
            <input type="password" id="confirm_password" name="confirm_password" placeholder="Xác nhận password của bạn.">
            ...
            <div class="gender">
                ...
                <div class="item_gender"><input type="radio" name="gender" id="famale" value="famale"><label for="famale">Nữ</label> <br></div>
                <div class="item_gender"><input type="radio" name="gender" id="not" value="not"><label for="not">Không
                        phân biệt
                        được</label>
                    <br>
                </div>
                <div class="item_gender"><input type="radio" name="gender" value="other" id="other"><label for="other">Khác</label> <br>
                </div>
                <div class="item_gender"><input type="radio" name="gender" value="private" id="private"><label for="private">Không muốn nêu cụ
                        thể</label> <br></div>
            </div>

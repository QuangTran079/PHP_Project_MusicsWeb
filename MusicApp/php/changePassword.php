...
<body>
    ...
    <div class="changePassword form_user">
        ...
        <form method="post" autocomplete="off" id="myform">
            ...
            <input type="password" id="confirm_password" name="confirm_password" placeholder="Xác nhận mật mới của bạn.">
            ...
            <div class="back_home" style="display: flex;align-items: center;justify-content: flex-end;">
                <a href="../index.php" style="display: block;font-size: 30px;color:black;margin-right: 10px;display:flex;justify-content: center;align-items: center;">
